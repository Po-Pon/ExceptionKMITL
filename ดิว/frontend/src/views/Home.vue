    ...
    <div class="container" style="padding-bottom: 20px;">
        ...
        <div class="row">
            <div class="col-md-10" id="article">
                <p><a href="">บทความยอดนิยม<br></a></p>
            </div>
            <div class="col-md-2" id="news" style="text-align: right;">
                <p><a href=""><br><i>ดูข่าวประชาสัมพันธ์</i><br><br></a></p>
            </div>
        </div>
                ...
                <a href="">
                    <div class="card">
                        ...
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-1.jpg" alt="Placeholder image">
                        </figure>
                        </div>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <div class="card-image">
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-2.jpg" alt="Placeholder image">
                        </figure>
                        </div>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <div class="card-image">
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-3.jpg" alt="Placeholder image">
                        </figure>
                        </div>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <div class="card-image">
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-4.jpg" alt="Placeholder image">
                        </figure>
                        </div>
                        <div class="card-header text-white bg-danger">การศึกษา</div>
                        <div class="card-body">
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <div class="card-image">
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-5.jpg" alt="Placeholder image">
                        </figure>
                        </div>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <div class="card-image">
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-6.jpg" alt="Placeholder image">
                        </figure>
                        </div>
                        <div class="card-header text-white bg-warning">สภาพแวดล้อม</div>
                        <div class="card-body">
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <div class="card-image">
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-7.jpg" alt="Placeholder image">
                        </figure>
                        </div>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <div class="card-image">
                        <figure class="image is-4by3">
                            <img src="/image/card/cardimg-8.png" alt="Placeholder image">
                        </figure>
                        </div>
                        <div class="card-header text-white bg-info">ทุนการศึกษา</div>
                        <div class="card-body">
